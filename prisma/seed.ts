...
async function main() {
  ...
  const associationsData = [
    {
      ...
      type: "nature",
      description:
        "Association dédiée à la protection et la reforestation des forêts tropicales. Nous plantons plus de 10 000 arbres par an.",
    ...
    },
    {
      ...
      type: "eau",
      description:
        "Protection des océans et de la vie marine. Nettoyage des plages et sensibilisation à la pollution plastique.",
    ...
    },
    {
      ...
      type: "humanitaire",
      description:
        "Aide humanitaire internationale. Nous apportons nourriture, eau et soins médicaux aux populations dans le besoin.",
    ...
    },
    {
      ...
      type: "air",
      description:
        "Lutte contre la pollution atmosphérique et promotion des énergies renouvelables.",
    ...
    },
    {
      ...
      type: "feu",
      description:
        "Prévention et lutte contre les incendies de forêt. Formation des populations locales et équipement des pompiers.",
  ...
  await prisma.event.create({
    data: {
      ...
      description:
        "Événement spécial : Sauvez la forêt des flammes ! Chaque don compte double pour éteindre le brasier.",
      type: "boss",
      status: "active",
      currentHealth: 750,
      maxHealth: 1000,
  ...
  const event = await prisma.event.findFirst({
    where: { name: "Le Brasier des Cimes" },
  });
  await prisma.hero.create({
    data: {
      name: "Ignis, le Soldat du Feu",
      description:
        "Un héros légendaire qui a combattu les flammes pour sauver la forêt. Récompense exclusive pour les meilleurs donateurs.",
